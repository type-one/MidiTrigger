...
namespace
{
    const std::map<std::string, midi_control> token_to_ctrl
        = { { "MIDICTRL_CONTINUOUS_CONTROLLER0_MSB", midi_control::MIDICTRL_CONTINUOUS_CONTROLLER0_MSB },
              ...
              { "MIDICTRL_OMNI_MODE_OFF", midi_control::MIDICTRL_OMNI_MODE_OFF },
              { "MIDICTRL_OMNI_MODE_ON", midi_control::MIDICTRL_OMNI_MODE_ON },
              { "MIDICTRL_POLY_MODE_ON_OFF", midi_control::MIDICTRL_POLY_MODE_ON_OFF },
              { "MIDICTRL_POLY_MODE_ON", midi_control::MIDICTRL_POLY_MODE_ON },
              { "MIDICTRL_CRTL_UNDEFINED", midi_control::MIDICTRL_CRTL_UNDEFINED } };
    ...
    const std::map<midi_control, std::string> ctrl_to_token
        = { { midi_control::MIDICTRL_CONTINUOUS_CONTROLLER0_MSB, "MIDICTRL_CONTINUOUS_CONTROLLER0_MSB" },
              ...
              { midi_control::MIDICTRL_OMNI_MODE_OFF, "MIDICTRL_OMNI_MODE_OFF" },
              { midi_control::MIDICTRL_OMNI_MODE_ON, "MIDICTRL_OMNI_MODE_ON" },
              { midi_control::MIDICTRL_POLY_MODE_ON_OFF, "MIDICTRL_POLY_MODE_ON_OFF" },
              { midi_control::MIDICTRL_POLY_MODE_ON, "MIDICTRL_POLY_MODE_ON" },
              { midi_control::MIDICTRL_CRTL_UNDEFINED, "MIDICTRL_CRTL_UNDEFINED" } };
