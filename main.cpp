...
namespace
{
    const std::map<std::string, MidiControl> token_to_ctrl = {
        ...
        {"MIDICTRL_OMNI_MODE_OFF", MidiControl::MIDICTRL_OMNI_MODE_OFF},
        {"MIDICTRL_OMNI_MODE_ON", MidiControl::MIDICTRL_OMNI_MODE_ON},
        {"MIDICTRL_POLY_MODE_ON_OFF", MidiControl::MIDICTRL_POLY_MODE_ON_OFF},
        {"MIDICTRL_POLY_MODE_ON", MidiControl::MIDICTRL_POLY_MODE_ON},
        {"MIDICTRL_CRTL_UNDEFINED", MidiControl::MIDICTRL_CRTL_UNDEFINED}
    };
    ...
    {MidiControl::MIDICTRL_OMNI_MODE_OFF, "MIDICTRL_OMNI_MODE_OFF"},
    {MidiControl::MIDICTRL_OMNI_MODE_ON, "MIDICTRL_OMNI_MODE_ON"},
    {MidiControl::MIDICTRL_POLY_MODE_ON_OFF, "MIDICTRL_POLY_MODE_ON_OFF"},
    {MidiControl::MIDICTRL_POLY_MODE_ON, "MIDICTRL_POLY_MODE_ON"},
    {MidiControl::MIDICTRL_CRTL_UNDEFINED, "MIDICTRL_CRTL_UNDEFINED"}
    };
...
public:
    ...
    explicit ParseAndTrigger(const std::string& p_name) : m_stop(false)
    {
    ...
    void process_message(double delta_time, const std::vector<unsigned char>& message)
    {
        ...
        try
        {
            ...
            if ((message[0] >= 0xB0) && (message[0] <= 0xBF)) // Channel aftertouch on channel 1 - 16
            {
                ...
                /* Korg Nano Kontrol 2*/
                if ((function >= MidiControl::MIDICTRL_CONTINUOUS_CONTROLLER0_MSB) && (function <= MidiControl::MIDICTRL_CONTINUOUS_CONTROLLER31_MSB))
                {
                ...
                else if ((function >= MidiControl::MIDICTRL_CONTINUOUS_CONTROLLER0_LSB) && (function <= MidiControl::MIDICTRL_CONTINUOUS_CONTROLLER31_LSB))
                {
